...
/**
  ...
  */
class KernelServiceImpl @Inject() (config: Config, secretService: SecretService, configuredDbName: Option[String]) extends KernelService {

  val logger = LoggerFactory.getLogger(this.getClass)

  val dbConfigPrefix = KernelService.confPath("db")
