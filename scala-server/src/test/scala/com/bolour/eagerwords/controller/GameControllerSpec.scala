...
class GameControllerSpec extends AuthControllerSpecBase with GameSpecBase {
  ...
  val gameController = new GameController(stubControllerComponents(), gameService, authService)
