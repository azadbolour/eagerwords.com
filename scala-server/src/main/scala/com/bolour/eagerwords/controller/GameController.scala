...
import com.bolour.util.message.HandShakeResponse
import com.bolour.auth.common.domain.AuthEvidence
import com.bolour.auth.server.domain.{EmailConstants, Login}
...
import com.bolour.eagerwords.server.service.{GameService, Version}

import com.bolour.auth.controller.AuthApiJsonSupport._
import GameDtoConverters._
...
/**
  ...
  */
@Singleton
class GameController @Inject() (cc: ControllerComponents, service: GameService, authService: AuthService) extends AbstractController(cc) {

  private val logger = LoggerFactory.getLogger(this.getClass)

  val serverType = "Scala"
  val apiVersion = Version.version.toString
