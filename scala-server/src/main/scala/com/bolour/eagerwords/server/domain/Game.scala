...
import com.bolour.eagerwords.common.domain.PlayerType._
import com.bolour.eagerwords.server.domain.GameExceptions.{CompletedGameOpException, InvalidCrosswordsException, MalformedPlayException}
...
//  def suspend(): Try[Game] = {
//    if (this.isGuestGame)
//      Failure(IllegalGuestOpException("suspend", this.gameBase.gameId))
//    else if (this.isCompleted)
//      Failure(CompletedGameOpException("suspend", this.gameBase.gameId))
//    else
//      Success(this.copy(
//          lastSecond = nowSecs,
...
//  def resume(): Try[Game] = {
//    if (this.isGuestGame)
//      Failure(IllegalGuestOpException("resume", this.gameBase.gameId))
//    else if (this.isCompleted)
//      Failure(CompletedGameOpException("resume", this.gameBase.gameId))
//    else
//      Success(this.copy(
//          lastSecond = nowSecs,
...
//  }
  ...
  def resign(): Try[Game] = {
    if (this.isCompleted)
      Failure(CompletedGameOpException("resign", this.gameBase.gameId))
    else Success(
      this.copy(
        lastSecond = nowSecs,
...
object GameObj {
  ...
  def mkGame(gameBase: GameBase, pieceProvider: PieceProvider): Try[Game] = {
