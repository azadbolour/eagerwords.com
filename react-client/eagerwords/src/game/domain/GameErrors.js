...
// import {errorClassifiers, defaultMessageTransformer, mkResponseToResultPromiseMapper, mkErrorData} from "../../jsutil/domain/BaseErrors";
import {BaseErrors} from 'lib/js-util/index';

import {stringify} from 'lib/js-util/index';
import {Result} from "../../lib/js-util/domain/Result";

let {errorClassifiers, defaultMessageTransformer, mkResponseToResultPromiseMapper, mkErrorData} = BaseErrors;
