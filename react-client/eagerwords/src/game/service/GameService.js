...
// import {apiMockErrorAdapter} from "../../jsutil/domain/ApiAdapters";
import {ApiAdapters} from 'lib/js-util/index';
// import {Vow} from "../../jsutil/domain/Vow";
...
let {apiMockErrorAdapter} = ApiAdapters;
...
class GameService {
  constructor(maybeLoginEvidence) {
    ...
    this.api = mkClientApi();
  }

  handShake(mockErrors) {
    let api = this.api;
    return serviceWrapper(mockErrors, api, api.handShake)
  }
