...
// import {unrecoverableCheckboxTestId} from "../../lib/react-support/index/components/Testing2Components";
// import {unrecoverableResetButtonTestId} from "../../lib/react-support/index/components/NotificationComponents";
import {NotificationComponents} from "lib/react-support/index";
import {stringify} from "../util/Logger";
import {TestingComponents} from 'lib/react-support/index';

let {unrecoverableCheckboxTestId} = TestingComponents;
...
test.skip('request login failure', async () => {
  ...
  let unrecoverableResetButton = await elementByTestId(NotificationComponents.unrecoverableResetButtonTestId);
