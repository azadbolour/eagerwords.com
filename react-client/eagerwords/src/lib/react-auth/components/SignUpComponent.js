...
let {defaultOpContext, opErrorMsg, opProcessingMsg, resetOpMessages,} = ComponentOperationState;
let {
  UnrecoverableModal,
  ProcessingSpinner
 ...
 * renderer of this component renders the corresponding sub-components for each step.
 *
...
class SignUpComponent extends Component {
  ...
  static propTypes = {
    ...
    EulaPrefaceComponent: PropTypes.func.isRequired,
